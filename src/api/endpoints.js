...
// --- Salary Ledger (Daily Deduction / Advance / Fine / Travel, for both
//     Employees and Labour/Wages workers) ---
export const getSalaryLedgerEntries = (params = {}) => api.get("/salary-ledger", { params });
export const createSalaryLedgerEntry = (payload) => api.post("/salary-ledger", payload);
export const deleteSalaryLedgerEntry = (id) => api.delete(`/salary-ledger/${id}`);
export const getSalaryLedgerPendingSummary = (params = {}) =>
  api.get("/salary-ledger/pending-summary", { params });
export const getTravelRate = () => api.get("/salary-ledger/travel-rate");
export const updateTravelRate = (payload) => api.put("/salary-ledger/travel-rate", payload);
